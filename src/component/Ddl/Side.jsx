...
const Side = () => {
  return (
    <div className="fixed left-0 top-0 h-full bg-gray-800 w-64 overflow-y-auto z-50">
      <nav id="hamburger" className="flex flex-col w-full">
        <div className="flex flex-col items-center mt-12 gap-4">
          <div className="mx-4 flex items-center justify-center w-full">
            <button className="bg-gray-700 hover:bg-gray-600 text-white px-4 py-2 rounded-md flex items-center w-full">
              <span>
          ...
          <div className="mx-4 bg-gray-600 p-4 rounded-md w-full">
            <h1 className="text-white font-bold text-lg">Your tables</h1>
          </div>
          <ul className="flex flex-col gap-2 mt-4 w-full">
            <li className="p-2 mx-4 rounded-md bg-gray-700 hover:bg-gray-600 transition duration-300 ease-in-out">
